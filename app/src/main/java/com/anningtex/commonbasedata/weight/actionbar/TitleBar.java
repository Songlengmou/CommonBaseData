package com.anningtex.commonbasedata.weight.actionbar;
...
import com.anningtex.commonbasedata.weight.actionbar.style.BaseTitleBarStyle;
import com.anningtex.commonbasedata.weight.actionbar.style.TitleBarLightStyle;
import com.anningtex.commonbasedata.weight.actionbar.style.TitleBarNightStyle;
import com.anningtex.commonbasedata.weight.actionbar.style.TitleBarRippleStyle;
import com.anningtex.commonbasedata.weight.actionbar.style.TitleBarTransparentStyle;
...
public class TitleBar extends FrameLayout implements View.OnClickListener, Runnable {
    ...
    public void setBackButton(boolean isBackButton) {
        mLeftView.setVisibility(isBackButton ? VISIBLE : INVISIBLE);
    }
